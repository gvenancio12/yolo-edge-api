...
entregáveis são `output/v1_naive_report.md` e
`output/v1_naive_diagnostic.json`, com 50 amostras individuais.
...
gera `output/v3_optimized.avi` em MJPEG/AVI, com bounding boxes e OSD de FPS e
latência.

Copie o arquivo para o computador com:

```powershell
scp guilherme@guilherme-raspberry:~/yolo-edge-api/output/v3_optimized.avi .\evidencias\
```
